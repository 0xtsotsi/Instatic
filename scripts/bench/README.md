...
This is the _user-facing output speed_ — what visitors will see.
      ...
      sections: [
        {
          ...
          rows: [{ label: 'thing A', metrics: { mean: '0.5ms', p95: '1.2ms' } }],
        },
      ],
    }
  },
...
## What this bench _doesn't_ measure
